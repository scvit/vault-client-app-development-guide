...
2. **Database Dynamic Secret 주입 실패**: Vault 토큰 및 Database 설정 확인
3. **Database 연결 실패**: MySQL 설정 및 Vault Dynamic Secret 확인
4. **Thymeleaf 렌더링 실패**: Thymeleaf 의존성 및 설정 확인
5. **KV/Static Secret 조회 실패**: VaultTemplate 설정 및 Vault API 권한 확인
